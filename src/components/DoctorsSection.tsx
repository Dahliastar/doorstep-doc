...
const DoctorsSection = () => {
  ...
  return <section id="doctors" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
          {filteredDoctors.map((doctor, index) => <div key={index} className="space-y-4">
              <DoctorCard {...doctor} />
              <AppointmentBooking doctorId={`doctor-${index}`} doctorName={doctor.name} specialty={doctor.specialty} />
            </div>)}
        </div>
        
        {filteredDoctors.length === 0 && (searchFilters.location || searchFilters.specialty) && <div className="text-center py-12">
